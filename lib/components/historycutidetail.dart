...
class HistoryCuti extends StatelessWidget {
  final String nik;
  final String ket;
  const HistoryCuti({Key?key,required this.nik,required this.ket}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    debugShowCheckedModeBanner: false,
      home: HistoryCutiDetail(nik: nik, ket: ket)
    );
  }
}


class HistoryCutiDetail extends StatefulWidget {
  final String nik;
  final String ket;

  const HistoryCutiDetail({Key?key,required this.nik,required this.ket }):super(key: key)  ;
  ...
  @override
  State<HistoryCutiDetail> createState() => _HistoryCutiDetailState( nik:nik,ket:ket);
}

class _HistoryCutiDetailState extends State<HistoryCutiDetail> {
 final String nik;
  final String ket;
  _HistoryCutiDetailState({Key?key,required this.nik,required this.ket })  ;
            ...
            children: [
             ...
             SingleChildScrollView(
              child: Container(
                ...
                child: 
                FutureBuilder(future: Provider.of<MapDatas>(context,listen: false).getHistoryCuti(nik,ket)
