...
//     await Provider.of<MapDatas>(context,listen:false).getHistory(ambilid.toString());
//   }
...
//   child: 
//   FutureBuilder(
//         future: Provider.of<MapDatas>(context,listen:false ).getHistory(ambilid.toString()),
//         builder: 
//         (context, snapshot) {
