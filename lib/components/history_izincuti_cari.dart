...
import 'package:flutter_attendance_current/components/historycuti_mainmenu.dart';
...
class HistoryIzincutiCari extends StatefulWidget {
  const HistoryIzincutiCari({super.key});

  @override
  State<HistoryIzincutiCari> createState() => _HistoryIzincutiCariState();
}

class _HistoryIzincutiCariState extends State<HistoryIzincutiCari> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("History Izin/Cuti",style: TextStyle(color: Colors.white),),
                ...
                return ListView.builder(
                  ...
                  return Card(
                      ...
                      onTap: () {
                        ...
                        //   );
                        // },);
                        Navigator.push(context, MaterialPageRoute(builder: (context) => HistoryCutiMainMenu1(nik: provx.globalperson_manualatt[i].nik!, nama: provx.globalperson_manualatt[i].nama_person!),));
